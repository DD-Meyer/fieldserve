...
| `@clerk/expo` or `@clerk/expo` | v1–v2 | v3+ |
| `@clerk/react-router` | v1–v2 | v3+ |
| `@clerk/tanstack-react-start` | < v0.26.0 | v0.26.0+ |

**Default to current** if the version is unclear or the project is new. Core 2 packages use `@clerk/clerk-react` and `@clerk/expo` (with `clerk-` prefix); current packages use `@clerk/react` and `@clerk/expo`.
