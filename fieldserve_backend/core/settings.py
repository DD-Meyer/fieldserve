...
CELERY_BEAT_SCHEDULE = {
    "purge-businesses-pending-deletion": {
        "task": "businesses.tasks.purge_businesses_pending_deletion",
...
CLERK_JWT_LEEWAY_SECONDS = int(os.environ.get("CLERK_JWT_LEEWAY_SECONDS", "30"))
